...
-- Not all clients have given birthdate
--------------------
...
SELECT COUNT(City), City, COUNT(ClientId) ClientId
FROM Client
Group BY City
;
...
SELECT InvoiceId, Sum(Price), InvoiceLineItemId, COUNT(Quantity) 
FROM InvoiceLineItem
Group BY InvoiceLineItemId
;
